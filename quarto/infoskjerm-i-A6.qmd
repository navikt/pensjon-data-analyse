...
# Ukas oppmerksomhet
## {height=100%}
::: {.card title="Ukas oppmerksomhet! Seksjon pensjon og uføretrygd representert fra team Regelverk på trygdeavtaleforhandlinger i Brasil"}
![](../data/brasil-forhandlinger.JPG)
:::
...
#| color: light
#| icon: patch-question
'Snakk med Brynjar og foreslå tall/plott/nettsider/bilder'
```
## {height=33%}
```{python}
#| content: valuebox
#| title: "Eventuelt kan du"
#| color: light
#| icon: eyeglasses
'Legge til endringer i github.com/navikt/infoskjerm-karusell/ i fila nettsider.yaml'
```
## {height=33%}
```{python}
#| content: valuebox
...
#| color: light
#| icon: eyeglasses
'Nettsider, bilder, plott, tall, gøy tekst eller noe annet som kan puttes i en nettside uten innlogging (evt AD-innlogging)'
```