...
df_rolle = df_pensjon["rolle"].value_counts().reset_index()
df_rolle.columns = ["Primærrolle", "Antall"]
df_rolle["Andel"] = df_rolle["Antall"] / df_rolle["Antall"].sum()
df_rolle["Andel"] = df_rolle["Andel"].map("{:.1%}".format)
```
...
# Count occurrences of each "rolle" and show in a table
df_rolle2 = df_pensjon["rolle2"].value_counts().reset_index()
df_rolle2.columns = ["Sekundærrolle", "Antall"]
df_rolle2["Andel"] = df_rolle2["Antall"] / df_rolle2["Antall"].sum()
df_rolle2["Andel"] = df_rolle2["Andel"].map("{:.1%}".format)
```
##
