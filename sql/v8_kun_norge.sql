...
s.K_SAK_T STØNADSOMRÅDE,
CASE
    WHEN sk.OPPRETTET_AV BETWEEN '00000000000' AND '99999999999' or k.KRAVKILDE IS NOT NULL THEN
        'bruker'
    ELSE 'saksbehandler'
END OPPRETTET_AV,
CASE
...
AND k.K_KRAV_GJELDER IN ('FORSTEG_BH')
and EXTRACT (year from k.DATO_OPPRETTET) >= 2019
