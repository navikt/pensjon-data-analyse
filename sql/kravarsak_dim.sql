-- Felles dimensjonstabell for kravårsak-mapping
-- Erstatter pen.t_k_krav_arsak_t
-- Kan brukes i andre SQL-spørringer via: WITH kravarsak_map AS (@@kravarsak_dim.sql)
